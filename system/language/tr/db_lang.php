...
$lang['db_invalid_connection_str'] = 'Girdiğiniz bilgilere göre, veritabanı ayarları hatalı yapılandırılmış.';
$lang['db_unable_to_connect'] = 'Girdiğiniz bilgilere göre veritabanıyla bağlantı kurulamıyor.';
$lang['db_unable_to_select'] = '%s veritabanı seçilemedi';
$lang['db_unable_to_create'] = '%s veritabanı oluşturulamadı.';
$lang['db_invalid_query'] = 'Girdiğiniz sorgu hatalıdır.';
...
$lang['db_must_use_index'] = 'Güncelleme yapabilmek için bir indeks değeri belirlemelisiniz.';
$lang['db_batch_missing_index'] = 'Bir ya da daha fazla satırı güncellemek için bir indeks değeri belirlemelisiniz.';
